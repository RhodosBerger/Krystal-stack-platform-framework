...
from backend.cms.data_synchronizer import DataSynchronizer, AngleOfView
from backend.cms.process_gravitator import ProcessGravitator, GravitationalProcess
