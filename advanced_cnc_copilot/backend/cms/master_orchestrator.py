...
try:
    from backend.cms.fanuc_wave_controller import FanucWaveController
    FANUC_AVAILABLE = True
except ImportError:
    FANUC_AVAILABLE = False
    FanucWaveController = None

from backend.cms.reverse_engineering_simulator import ReverseEngineeringSimulator, SyntheticProject
from backend.cms.producer_effectiveness_engine import PartOptimizationBot, ProducerStatistics, EconomicTier
from backend.cms.solidworks_simulation_validator import IntegratedOptimizationSystem
from backend.cms.llm_context_system import RealTimeLLMAccessor
from backend.cms.synthetic_data_generator import PartTemplateGenerator, SyntheticOperationDataGenerator
