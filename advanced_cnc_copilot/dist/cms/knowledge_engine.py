...
class KnowledgeEngine:
    ...
    def generate_propedeutics(self, topic: str) -> str:
        ...
        # 2. Synthesize Propedeutics (Mock LLM Call for now, would route to llm_router)
        prompt = f"""
        ...
        # In production: return llm_router.query(prompt)
        return f"[Generated Guide for {topic}]\n\nBased on {structured_info or 'general knowledge'}..."
